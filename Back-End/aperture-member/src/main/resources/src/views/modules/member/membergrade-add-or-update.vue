<template>
  <el-dialog
    ...
    <el-form-item label="当前等级经验值" prop="currentValue">
      <el-input v-model="dataForm.currentValue" placeholder="当前等级经验值"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          currentValue: [
            { required: true, message: '当前等级经验值不能为空', trigger: 'blur' }
          ]
        }
      }
    },
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.currentValue = data.memberGrade.currentValue
              }
            })
          }
        })
