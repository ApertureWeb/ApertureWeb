...
public class CodeGenerator {
     ...
     */
    private static final String MYSQL_URL = "jdbc:mysql://127.0.0.1:3306/aperture_acl?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8";
    private static final String MYSQL_USER = "root";
    private static final String MYSQL_PASSWORD = "root";
    private static final String PACKAGE_PATH = "com.aperture.acl";//改成自己的包名
    private static final String OUTPUT_PATH = "/aperture_acl/src/main/java";//一般来说，将前面的core-service改为自己模块的就好了
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude("scs_permission", "scs_role", "scs_role_permission", "scs_user", "scs_user_role_relation");
