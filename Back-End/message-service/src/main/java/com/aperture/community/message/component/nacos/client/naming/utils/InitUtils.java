...
import com.aperture.community.message.component.nacos.api.selector.NoneSelector;
import com.aperture.community.message.component.nacos.api.selector.SelectorType;
import com.aperture.community.message.component.nacos.client.utils.ParamUtil;
import com.aperture.community.message.component.nacos.client.utils.TemplateUtils;
import com.aperture.community.message.component.nacos.client.utils.TenantUtil;
        ...
        if (Boolean.parseBoolean(isUseCloudNamespaceParsing)) {
            ...
            tmpNamespace = TemplateUtils.stringEmptyAndThenExecute(tmpNamespace, new Callable<String>() {
                ...
                public String call() {
                    ...
                    logger.info("initializer namespace from System Property :" + namespace);
                    return namespace;
                }
            });
            ...
            tmpNamespace = TemplateUtils.stringEmptyAndThenExecute(tmpNamespace, new Callable<String>() {
                ...
                public String call() {
                    ...
                    logger.info("initializer namespace from System Environment :" + namespace);
                    return namespace;
                }
            });
        }
